...
import { tableWrap, table, th, td, btnAction, income, expense, iconBtn } from "../styles";
...
export function TransactionList({ transactions, categories, persons, onEdit, onDelete, onViewReceipt }: Props) {
