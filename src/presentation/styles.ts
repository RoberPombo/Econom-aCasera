...
const inputBase =
  "rounded-lg border border-line bg-surface p-2 text-[0.95rem] text-body";
...
export const th =
  "border-b border-line p-2.5 text-left font-semibold text-muted";
...
export const categoryGrid =
  "mt-4 grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-6";
export const listReset = "m-0 list-none p-0";
export const listItem =
  "flex items-center justify-between border-b border-line py-1.5";
...
export const formRow =
  "mb-3 grid grid-cols-[100px_1fr] items-center gap-2 max-mobile:grid-cols-1";
...
export const modal =
  "w-[92%] max-w-[700px] rounded-lg bg-surface p-6 shadow-card";
...
export const header =
  "mb-4 flex flex-wrap items-center justify-between gap-4 max-mobile:flex-col max-mobile:items-start";
...
export const mainLayout =
  "grid grid-cols-1 gap-6 ultrawide:grid-cols-[minmax(420px,480px)_1fr]";
export const chartSection = "mb-6 ultrawide:mb-0";
export const chartGrid =
  "grid grid-cols-1 gap-4 tablet:grid-cols-2 ultrawide:grid-cols-1";
...
export const receiptDropzone =
  "rounded-lg border border-dashed border-line bg-surface p-3";
export const receiptPreview =
  "max-h-48 max-w-full rounded-lg border border-line object-contain";
