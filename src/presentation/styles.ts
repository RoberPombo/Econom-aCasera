...
export const summaryGrid = "mb-6 grid grid-cols-[repeat(auto-fit,minmax(160px,1fr))] gap-4";
...
export const modal = "w-[90%] max-w-[420px] rounded-lg bg-surface p-6 shadow-card";
...
export const themeToggle = `${btnBase} ml-auto rounded-lg border border-line bg-surface px-2.5 py-1.5 text-xl text-body`;
export const viewControls = "mb-4 flex flex-wrap items-center justify-between gap-3";
export const viewModeGroup = "flex gap-1";
export const viewModeBtn = `${btnBase} bg-primary first:rounded-l-lg last:rounded-r-lg`;
export const viewModeBtnActive = `${btnBase} bg-[#1e40af] shadow-[inset_0_2px_4px_rgba(0,0,0,0.2)] first:rounded-l-lg last:rounded-r-lg`;
export const tabs = "mb-6 flex flex-wrap gap-1";
export const tabBtn = btnGhost;
export const tabBtnActive = btnGhostActive;
