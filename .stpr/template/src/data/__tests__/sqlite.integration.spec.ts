// Referencia de tests de integración con SQL real (extracto de src/data/__tests__/sqlite.integration.spec.ts).
// Se omite el bloque TauriImportRepository para mantener el ejemplo autocontenido.
